...
def run_again(sleep_time):
    try:
        os.system('python3 {}/alarm_popup_1.0.py {} --message="Take_a_break_and_refresh"'.format(os.getcwd(),
                                                                                                 sleep_time))
    except SystemError:
        os.system('python {}/alarm_popup_1.0.py {} --message="Take_a_break_and_refresh"'.format(os.getcwd(),
                                                                                                sleep_button))
